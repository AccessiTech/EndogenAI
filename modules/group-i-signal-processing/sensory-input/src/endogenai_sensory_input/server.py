"""FastAPI server for the sensory-input module.
...
app = FastAPI(title="sensory-input", version="0.1.0")
...
if __name__ == "__main__":
    ...
    uvicorn.run("endogenai_sensory_input.server:app", host="0.0.0.0", port=port, reload=False)
