"""FastAPI server for the perception module.
...
app = FastAPI(title="perception", version="0.1.0")
...
if __name__ == "__main__":
    ...
    uvicorn.run("endogenai_perception.server:app", host="0.0.0.0", port=port, reload=False)
