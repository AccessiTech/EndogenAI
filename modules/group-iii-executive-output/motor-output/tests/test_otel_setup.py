"""test_otel_setup.py — Unit tests for motor-output OTel configuration.
...
import motor_output.instrumentation.otel_setup as _otel
...
def test_add_otel_trace_context_suppresses_errors() -> None:
    """If opentelemetry raises, the processor still returns event_dict safely."""
