"""otel_setup.py — OpenTelemetry TracerProvider configuration for motor-output.
...
Usage (in server.py lifespan)::
    ...
    from motor_output.instrumentation.otel_setup import configure_telemetry
