"""otel_setup.py — OpenTelemetry TracerProvider configuration for working-memory.
...
Usage (in server.py lifespan)::
    ...
    from working_memory.instrumentation.otel_setup import configure_telemetry
...
They are currently available as transitive deps; add explicit pyproject.toml deps in Phase 9
...
def configure_telemetry(
    ...
    service_name: str = "working-memory",
