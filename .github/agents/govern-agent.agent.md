...
1. [`.github/agents/AGENTS.md`](./AGENTS.1. [`.github/agents/AGENTS.md`](./AGENTS.1. [`.github/agents/AGTS.md1. [`.github/agemd1. [`.github/agents/AGENTS.md`](./AGENTS.1. [`.github/agents/AGENTS.md`](./AGENTS.1. [`.github/agents/AGTS.md1. [`.github/agemd1. [`.github/agents/AGENTS.md`]odules/AG1. [`.github/agrast1. [`.github/amd. [`.uvnaming pattern, agents that generate/validaensnaming pattern, agents that generate/validatenaming pattern, agents that generate/validatenaming uvnaming pattern, agents that generate/validaensnaming pattern, agents that generate/validatenaming pattern, agents that generate/validatenaming uvnaming pattern, agents that generate/validaensnaming pattern, agents that generate/validatenaming pattern, agents thaGuardrails

- **Read-only** — do not create, edit, or delete any file.
- **Full fleet scope** — always audit all `.github/agents/` files, not- **Full fleet scope** — always audit all `.github/agents/` files, notDo not commit** — hand off to Update Agent, then Review Agent, then GitHub.
